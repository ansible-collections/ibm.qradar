...
class ActionModule(ActionBase):
    ...
    def search_for_resource(
        self, qradar_request, search_for_resource=None
    ):
    ...
    def run(self, tmp=None, task_vars=None):
        ...
        if self._task.args["config"].get('range'):
            headers={"Content-Type": "application/json", "Range": "items={0}".format(self._task.args["config"]['range'])}
