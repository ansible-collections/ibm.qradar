...
DOCUMENTATION = """
---
module: qradar_offenses
short_description: Qradar Offenses Management resource module
description:
  - This module allows for configuration of Qradar Siem Offfenses.
version_added: "2.1.0"
options:
  config:
    description: A dictionary of Qradar Siem Offfenses.
    type: list
    elements: dict
    suboptions:
      name:
